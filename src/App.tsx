...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 pb-24 md:pb-20">
            ...
            {isLoading || (error && !coordinates) ? (
              ...
              <>
                {currentConditions && forecast.length > 0 ? (
                  ...
                  <section id="current" className="bg-slate-100 dark:bg-slate-900 scroll-mt-24 md:scroll-mt-28">
                    <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                {hourlyForecast.length > 0 ? (
                  ...
                  <section id="hourly" className="bg-slate-100 dark:bg-slate-900 scroll-mt-24 md:scroll-mt-28">
                ...
                {forecast.length > 0 ? (
                  ...
                  <section id="forecast" className="bg-slate-100 dark:bg-slate-900 scroll-mt-24 md:scroll-mt-28">
                    <div className="max-w-7xl mx-auto px-4 py-8">
                      <div className="max-w-6xl mx-auto">
                        <ErrorMessage
                ...
                {monthlyForecast ? (
                  ...
                  <section id="monthly" className="bg-slate-100 dark:bg-slate-900 scroll-mt-24 md:scroll-mt-28">
                    <div className="max-w-7xl mx-auto px-4 py-8">
                      <div className="max-w-6xl mx-auto">
